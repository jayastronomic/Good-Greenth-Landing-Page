...
const Body = () => {
    return(
        <div className="container mx-auto p-8" >
                <div className="center border-solid border-green-300 border-2">
                    <p className="text-center"> 
                      ...
                      Now why wouldn't I want that to be good. My favorite color is green and I love weed lol so I think this all can fit into the theme quite well. 
                      Each song and every bar is a seed to plant into my listeners ears to help them grow and grow with them. It's always gon be good tho. 
                    </p>
                </div>
        </div>
    )
